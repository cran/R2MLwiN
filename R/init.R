.onAttach <- function(...) {
  if (is.null(getOption("MLwiN_path"))) {
    ...
    if (Sys.info()["sysname"] == "Windows") {
      options(MLwiN_path = "C:/Program Files/MLwiN v3.06/")
    }
  }
  packageStartupMessage("")
  packageStartupMessage("R2MLwiN: A package to run models implemented in MLwiN from R")
  packageStartupMessage("Copyright 2013-2022 Zhengzheng Zhang, Christopher M. J. Charlton, Richard M. A. Parker, William J. Browne and George Leckie")
  packageStartupMessage("")
